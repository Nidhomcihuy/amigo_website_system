...
// $conn->close(); // Jika ini hanya snippet, biarkan terbuka
?>
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
  ...
  <section class="menu" id="menu">
    <h2 class="scroll-reveal">Our Menu</h2>

    <div class="menu-categories scroll-reveal">
    ...
    <p id="menu-description" class="menu-description fade show scroll-reveal">
...
<?php if ($q && $q->num_rows > 0) { ?>
  ...
  <?php while($p = $q->fetch_assoc()) { ?>
    ...
    <div class="product-card scroll-reveal" data-category="<?php echo $p['KATEGORI_PRODUCT']; ?>">
...
<?php } else {
  echo "<p class='scroll-reveal'>Tidak ada produk.</p>";
} ?>

  <button class="view-more scroll-reveal" onclick="window.location.href='menu.php'">
      Pergi ke menu
  </button>
</section>
...
lebih berwarna 🍰✨</p>
      ...
      <div class="book-map scroll-reveal">
        <h3>Lokasi Kami</h3>
        <iframe 
  ...
  <section class="galeri">
    <div class="galeri-container">
      <div class="book-text">
        ...
        <h2 class="scroll-reveal">Galeri Kegiatan Kami</h2>
        <p class="galeri-subtitle scroll-reveal">"Momen berharga yang kami abadikan dalam setiap langkah perjalanan bersama.✨"</p>

        <div class="galeri-grid">

            <div class="galeri-card scroll-reveal"> <div class="galeri-image" style="background-image: url('image_costumer/coba5.jpeg');"></div>
              <div class="galeri-info">
                <h3>Ngopaski</h3>
              </div>
            </div>

            <div class="galeri-card scroll-reveal" style="transition-delay: 0.1s;"> <div class="galeri-image" style="background-image: url('image_costumer/coba5.jpeg');"></div>
              <div class="galeri-info">
                <h3>Ngopaski</h3>
              </div>
            </div>

            <div class="galeri-card scroll-reveal" style="transition-delay: 0.2s;">
            ...
            <div class="galeri-card scroll-reveal" style="transition-delay: 0.3s;">
              <div class="galeri-image" style="background-image: url('image_costumer/coba5.jpeg');"></div>
              <div class="galeri-info">
                <h3>Ngopaski</h3>
              </div>
  ...
  <script>
    ...
    const descriptions = {
      ...
      "Custom Cake": "🎂 Sponge cake / buttercake yang diberi isian diplomat cream atau fresh cream, dilapisi buttercream, cocok untuk ulang tahun dan event spesial 🎂",
      "Mille Crepes": "🍮 Tumpukan crepes lembut dengan fresh cream di setiap lapisan. Varian: coklat, biscoff, oreo, buah musiman 🍮",
      "Cheesecake": "🧀 Cream cheese lembut yang dipanggang atau dikukus, cocok dengan topping blueberry, strawberry atau tanpa topping 🧀",
      "Soft Cookies": "🍪 Luar crunchy, dalam lembut. Varian classic, choco chunk, red velvet cheese, dan banyak lagi 🍪"
    };
  ...
  <script>
    // Pilih semua elemen dengan kelas scroll-reveal
    ...
    function checkVisibility() {
      scrollRevealElements.forEach(element => {
        ...
        // Tampilkan elemen jika bagian atasnya kurang dari 85% tinggi viewport
        // windowHeight * 0.85 memberikan sedikit margin dari bawah
        if (elementTop < windowHeight * 0.85) {
          element.classList.add("show");
        } 
        // Opsional: hapus kelas 'show' jika elemen sudah jauh di atas viewport (untuk animasi ulang saat scroll ke atas)
        /*
    ...
    // Jalankan fungsi saat halaman dimuat (untuk elemen yang sudah terlihat)
    checkVisibility();

    // ========== LIGHTBOX POP-UP (Tidak ada perubahan, hanya mengganti .fade-card menjadi .galeri-card) ==========  
